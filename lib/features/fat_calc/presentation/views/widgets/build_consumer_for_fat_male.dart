...
class BuildConsumerForFatMale extends StatelessWidget {
          ...
          return Column(
            children: [
              ...
              SizedBox(
                ...
                child: AppButton(
                  onPressed: () {
                    context.read<FatCalcCubit>().fatCalcMale();
                  },
                  radius: 20.r,
                ...
                child: Column(
                  children: [
                    ...
                    FatCalcInfo(
                      text: 'وزن الدهون',
                      val:
                          '${state.instance.data!.fatMass} ${S.of(context).kilo} ',
                    ),
                    SizedBox(
                      height: 9.h,
                    ),
                    FatCalcInfo(
                      ...
                      val:
                          '${state.instance.data!.leanMass} ${S.of(context).kilo}',
                    ),
                    SizedBox(
                      height: 9.h,
                    ),
